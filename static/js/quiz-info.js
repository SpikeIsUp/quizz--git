...
async function loadQuestions() {
    try {
        const response = await fetch('/info/api/quiz');
...
async function showResults() {
    ...
    if (percentage >= 90) {
        level = '🏆 ARCHITECTE LOGICIEL';
        message = 'EXCEPTIONNEL! Vous maîtrisez l\'informatique à la perfection.';
        color = '#FFD700';
    } else if (percentage >= 75) {
        level = '💎 DÉVELOPPEUR SENIOR';
        message = 'EXCELLENT! Vous avez une solide culture informatique.';
        color = '#0ff';
    } else if (percentage >= 60) {
        level = '💻 DÉVELOPPEUR CONFIRMÉ';
        message = 'BIEN! Vous avez de bonnes bases en informatique.';
        color = '#0f0';
        ...
        level = '🔰 APPRENTI CODEUR';
        message = 'DÉBUT DE PARCOURS. Étudiez les bases de l\'informatique!';
        color = '#f80';
    }
